...
// de IA do 7Commander, acessivel de qualquer tela pelo botao flutuante, nao
// um modulo de gestao com o mesmo peso de Projetos/Atividades.
const NAV_ITEMS = [
      ...
      >
        ...
        <div className="sidebar-product sidebar-rail-only relative">
          ...
          <div className="mt-3 rounded-xl border border-cyan-300/30 bg-cyan-300/10 px-3 py-2">
            ...
            <p className="mt-1 text-[13px] leading-4 text-white/70">Dados fictícios salvos somente neste navegador.</p>
            <button type="button" onClick={resetDemoData} className="mt-2 text-[13px] font-semibold text-cyan-100 underline underline-offset-2">Restaurar dados iniciais</button>
          </div>
        </div>
